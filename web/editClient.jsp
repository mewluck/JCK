...
<ul class="nav navbar-left navbar-nav navbar-inverse col-md-3">
    ...
    <li class="activee"><a href="ClientEdit.jsp">Clients</a></li>
...
<div class="col-md-4">
    ...
    <%
                ...
                String rating = request.getParameter("registerRating");
                String ccn = request.getParameter("registerCCN");
                                ...
                                try {
                                    ...
                                    stmt1.executeUpdate("UPDATE client SET Email = '"+email+"', Rating = '"+rating+"', CreditCardNumber='"+ccn+"' WHERE Id = '"+id+"'");
                                    
                                    String query = "SELECT * FROM client";
                                    
                                    java.sql.PreparedStatement ps = conn.prepareStatement(query);
                                    java.sql.ResultSet rs = ps.executeQuery();
                                    query = "SELECT P.FirstName,P.LastName,P.Address, P.ZipCode, P.Telephone, P.City, P.State FROM person P,client c WHERE P.SSN = c.Id";
                            ...
                            <form name="myForm" action="editClient.jsp" method="post">
                                                        <div class="form-group">
                                <input type="ssn" class="form-control" name="registerSSN" id="registerSSN" placeholder="Client ID">
                            </div>    
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="registerRating" id="registerPhone" placeholder="Rating">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="registerCCN" id="registerPhone" placeholder="Credit Card Number">
                            </div>    
                                

                            <button type="submit" value="editEmployee" onclick="return Button1_onclick()" class="btn btn-default">Edit Client Information</button>
                        </form> 
                            </div>
