...
<ul class="nav navbar-left navbar-nav navbar-inverse col-md-3">
    ...
    <li class="active"><a href="SharePrice.jsp">Set Share Price</a></li>
...
<div class="col-md-4 row">
    ...
    <%      
                String stockSym = request.getParameter("stockSymbol");
                ...
                String mysPassword = "108695120";
                                ...
                                try {
                                    ...
                                    stmt1.executeUpdate("UPDATE stock SET PricePerShare='"+price+"' WHERE StockSymbol='"+stockSym+"'");                                    
                            ...
                            <form name="myForm" action="newSharePrice.jsp" method="post">
                                <div class="form-group">
                                <input type="text" class="form-control" name="stockSymbol" id="registerPassword" placeholder="Stock Symbol">
                                </div>
                                <div class="form-group">
                                <input type="number" class="form-control" step=".01" name="price" id="registerPassword" placeholder="PricePerShare">
                            </div>
                                <button type="submit" value="Register" class="btn btn-default">Update</button>
                            </form>
                            </div>
