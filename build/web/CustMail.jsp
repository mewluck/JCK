...
<ul class="nav navbar-left navbar-nav navbar-inverse col-md-3">
    ...
    <li class="active"><a href="CustMail.jsp">Customer MailingList</a></li>
    <li><a href="StockSuggestion.jsp">Stock Suggestion</a></li>
</ul>
</div>  
    
<h1><strong>Customer Mailing List</strong></h1>
<%
                ...
                java.sql.Connection conn = null;
                                ...
                                try {
                                    ...
                                    String query = "SELECT P.LastName, P.FirstName, C.Email FROM Client C, Person P WHERE P.SSN = C.Id";
